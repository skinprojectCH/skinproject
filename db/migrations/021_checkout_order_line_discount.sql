-- checkout_order: Positions-Rabatt (pro Service/Artikel) wird jetzt mitgespeichert.
-- Die Spalten order_line_items.discount_type/discount_value existierten bereits im
-- Schema, wurden aber von der Funktion bisher ignoriert. Kein Signaturwechsel, daher
-- kein vorheriges drop nötig -- create or replace reicht.
